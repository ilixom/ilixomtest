...
const QString BITCOIN_IPC_PREFIX("ilixomtest:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/ilixomtest-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ilixomtest-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ilixomtest-paymentrequest";
...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // ilixomtest: URI
        {
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click ilixomtest: links
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start ilixomtest: click-to-pay handler"));
        }
        else {
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in ilixomtest: URIs
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // ilixomtest: URI
    {
#if QT_VERSION < 0x050000
        QUrl uri(s);
#else
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Ilixomtest address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
