...
but if posiltle use one of the above styles.
...
Ilixomtest Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Ilixomtest Core, where everyone uses
...
pay attention to for reviewers of Ilixomtest Core code.

General Ilixomtest Core
----------------------
...
- Use the RAII (Resource Acquisition Is Initialization) paradigm where posiltle. For example by using
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Ilixomtest Core uses tinyformat, which is type safe. Leave them out to avoid confusion
