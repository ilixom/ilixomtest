...
Fix posiltle buffer overflow on systems with very long application data paths. This is not exploitable.
...
Enable accesiltle widgets on Windows, so that people with screen readers such as NVDA can make sense of it.
Various build fixes.
